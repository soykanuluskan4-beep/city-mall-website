...
const content = {
  tr: {
    eyebrow: "Kampanyalar",
    title: "CityMall kampanyalarını keşfet.",
    description:
      "Moda, teknoloji, yeme-içme, aile ve sinema fırsatlarını tek yerden inceleyin.",
    categoryTitle: "Kategori",
    statusTitle: "Durum",
    totalCampaigns: "kampanya",
    listedCampaigns: "kampanya listeleniyor",
    noResultsTitle: "Uygun kampanya bulunamadı",
    noResultsText: "Kategori veya durum filtresini değiştirerek tekrar deneyebilirsin.",
  ...
  en: {
    eyebrow: "Campaigns",
    title: "Explore CityMall campaigns.",
    description:
      "View fashion, technology, dining, family and cinema offers in one place.",
    categoryTitle: "Category",
    statusTitle: "Status",
    totalCampaigns: "campaigns",
    listedCampaigns: "campaigns listed",
    noResultsTitle: "No matching campaign found",
    noResultsText: "Try changing the category or status filter.",
