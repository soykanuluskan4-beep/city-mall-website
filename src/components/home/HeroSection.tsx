    ...
    <section className="relative isolate flex min-h-[calc(100vh-72px)] overflow-hidden bg-text-primary text-text-inverse">
      ...
      <div className="container flex flex-1 items-end pb-16 pt-28 md:pb-20 lg:pb-24">
        <div className="max-w-5xl">
          ...
          <h1 className="max-w-[14ch] text-[clamp(2.75rem,10.5vw,4.2rem)] font-semibold leading-[0.95] tracking-tight text-white [overflow-wrap:normal] [word-break:normal] md:max-w-5xl md:text-7xl md:leading-[0.95] lg:text-8xl">
            {copy.title}
          </h1>
