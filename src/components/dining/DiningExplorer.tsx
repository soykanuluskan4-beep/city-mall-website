...
const content = {
  tr: {
    eyebrow: "Yeme-İçme",
    title: "CityMall Cyprus’ta lezzet molası.",
    description:
      "Cafe, restoran, fast food, tatlı ve atıştırmalık seçeneklerini mutfak tipi, konum ve mekan türüne göre keşfedin.",
    cuisineTitle: "Mutfak Tipi",
    floorTitle: "Konum",
    typeTitle: "Mekan Türü",
    totalPlaces: "mekan",
    listedPlaces: "mekan listeleniyor",
    noResultsTitle: "Mekan bulunamadı",
  ...
  en: {
    eyebrow: "Dining",
    title: "Take a flavorful break at CityMall Cyprus.",
    description:
      "Explore cafes, restaurants, fast food, desserts and snack options by cuisine, location and place type.",
    cuisineTitle: "Cuisine",
    floorTitle: "Location",
    typeTitle: "Place Type",
    totalPlaces: "places",
    listedPlaces: "places listed",
    noResultsTitle: "No dining places found",
