...
const content = {
  tr: {
    ...
    title: "Hediye vermek hiç bu kadar kolay olmamıştı.",
    description:
      "CityMall Cyprus hediye kartı ile sevdiklerinize alışveriş, yeme-içme ve eğlence deneyimi hediye edin.",
    primaryCta: "Satın Al",
    secondaryCta: "Nasıl Çalışır?",
    selectedValue: "Seçili değer",
    chooseValue: "Kart Değeri Seç",
    demoNote:
      "Bu satın alma akışı demo amaçlıdır. Gerçek satış koşulları ve ödeme entegrasyonu CityMall Cyprus tarafından belirlenir.",
    howItWorksTitle: "Nasıl Çalışır?",
    howItWorksText:
      "Hediye kartı deneyimi üç basit adımda ziyaretçilere kolay bir hediye alternatifi sunar.",
    steps: [
      {
        title: "Al",
        text: "50₺, 100₺, 250₺ veya 500₺ değer seçeneklerinden birini seçin.",
      },
      {
        title: "Ver",
        text: "Kartı doğum günü, bayram, yılbaşı veya özel günlerde sevdiklerinize hediye edin.",
      },
      {
        title: "Harca",
        text: "Katılımcı mağazalarda alışveriş deneyimine dönüştürün.",
      },
    ],
    storesTitle: "Katılımcı Mağazalar",
    storesText:
      "Hediye kartı kullanımı mağaza ve kampanya koşullarına göre değişebilir. Güncel kullanım bilgisi için danışma noktasından bilgi alın.",
    storeCta: "Mağazaları Gör",
    ...
    terms: [
      ...
      "Bu sayfadaki satın alma akışı demo amaçlıdır; gerçek satış koşulları CityMall Cyprus tarafından belirlenir.",
    ],
    modal: {
      eyebrow: "Hediye Kartı",
      title: "Demo satın alma akışı",
      text: "Bu alanda gerçek ödeme alınmaz. Ticari projede hediye kartı satışı ödeme sistemi, fiziksel kart veya dijital kod altyapısı ile entegre edilebilir.",
  ...
  en: {
    eyebrow: "Gift Card",
    title: "Gifting has never been this easy.",
    description:
      "Give your loved ones a CityMall Cyprus shopping, dining and entertainment experience with a gift card.",
    primaryCta: "Buy Gift Card",
    secondaryCta: "How It Works",
    selectedValue: "Selected value",
    chooseValue: "Choose Card Value",
    demoNote:
      "This purchase flow is for demo purposes. Real sales terms and payment integration are determined by CityMall Cyprus.",
    howItWorksTitle: "How It Works",
    howItWorksText:
      "The gift card experience gives visitors an easy gifting option in three simple steps.",
    steps: [
      {
        title: "Buy",
        text: "Choose one of the 50₺, 100₺, 250₺ or 500₺ value options.",
      },
      {
        title: "Gift",
        text: "Give the card to your loved ones for birthdays, holidays, New Year or special occasions.",
      },
      {
        title: "Spend",
        text: "Turn it into a shopping experience at participating stores.",
      },
    ],
    storesTitle: "Participating Stores",
    storesText:
      "Gift card usage may vary by store and campaign terms. Please ask the information desk for current usage details.",
    storeCta: "View Stores",
    ...
    terms: [
      ...
      "This purchase flow is for demo purposes; real sales terms are determined by CityMall Cyprus.",
    ],
    modal: {
      eyebrow: "Gift Card",
      title: "Demo purchase flow",
      text: "No real payment is taken here. In a commercial project, gift card sales can be integrated with payment, physical card or digital code infrastructure.",
