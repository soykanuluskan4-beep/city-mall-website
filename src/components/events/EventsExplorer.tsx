...
const content = {
  tr: {
    eyebrow: "Etkinlikler",
    title: "CityMall etkinlik takvimini keşfet.",
    description:
      "Çocuk atölyeleri, canlı müzik, aile buluşmaları, sinema programları ve özel etkinlikleri tek yerden takip edin.",
    ...
    noResultsTitle: "Uygun etkinlik bulunamadı",
    noResultsText: "Kategori veya tarih filtresini değiştirerek tekrar deneyebilirsin.",
  ...
  en: {
    eyebrow: "Events",
    title: "Explore the CityMall event calendar.",
    description:
      "Follow kids workshops, live music, family gatherings, cinema programs and special events in one place.",
    ...
    noResultsTitle: "No matching event found",
    noResultsText: "Try changing the category or date filter.",
