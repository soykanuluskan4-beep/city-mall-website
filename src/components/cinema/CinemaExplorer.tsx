...
const content = {
  tr: {
    eyebrow: "Cinemall",
    title: "Gazimağusa’da film keyfi Cinemall’da.",
    description:
      "Güncel filmler, günlük seans saatleri ve yakında vizyona girecek yapımları keşfedin.",
    halls: "5 Salon",
    daily: "Günlük Seanslar",
    family: "Aile Dostu Filmler",
    demo: "Demo Bilet Akışı",
    featuresTitle: "Cinemall özellikleri",
    nowShowing: "Vizyondaki Filmler",
    nowShowingText: "Cinemall’da bu hafta izleyebileceğiniz filmleri keşfedin.",
    comingSoon: "Yakında Vizyonda",
    comingSoonText: "Cinemall’da yakında gösterime girecek yapımlar.",
  ...
  en: {
    eyebrow: "Cinemall",
    title: "Movie moments at Cinemall.",
    description:
      "Explore current movies, daily showtimes and upcoming releases.",
    halls: "5 Halls",
    daily: "Daily Showtimes",
    family: "Family-friendly Movies",
    demo: "Demo Ticket Flow",
    featuresTitle: "Cinemall features",
    nowShowing: "Now Showing",
    nowShowingText: "Discover the movies you can watch at Cinemall this week.",
    comingSoon: "Coming Soon",
    comingSoonText: "Upcoming releases at Cinemall.",
